...
do -- ACF global vars
	...
	ACF.DefineSetting(
		"NameAndShame",
		false,
		"Console messages for failed legality checks have been %s.",
		ACF.BooleanDataCallback()
	)
	ACF.DefineSetting(
		"VehicleLegalChecks",
		true,
		"Legality checks for vehicles has been %s.",
		ACF.BooleanDataCallback()
	)
	...
	ACF.DefineSetting(
		"AllowBaseplateDamage",
		false,
		"Non-ACF damage while driving baseplates has been %s.",
		ACF.BooleanDataCallback()
	)
	ACF.DefineSetting(
		"SquishyDamageMult",
		1,
		"Player/NPC damage multiplier has been set to a factor of %.2f.",
		ACF.FloatDataCallback(0.1, 2, 2)
	)
	...
	ACF.DefineSetting(
		"HealthFactor",
		1,
		"Health multiplier has been set to a factor of %.2f.",
		ACF.FactorDataCallback("Threshold", 0.01, 2, 2)
	)
	...
	ACF.DefineSetting(
		"ArmorFactor",
		1,
		"Armor multiplier has been set to a factor of %.2f.",
		ACF.FactorDataCallback("ArmorMod", 0.01, 2, 2)
	)
	...
	ACF.DefineSetting(
		"FuelFactor",
		1,
		"Fuel rate multiplier has been set to a factor of %.2f.",
		ACF.FactorDataCallback("FuelRate", 0.01, 2, 2)
	)
	...
	ACF.DefineSetting("MaxThickness", 100, nil, ACF.FloatDataCallback(ACF.MinimumArmor, ACF.MaximumArmor, 0))

	ACF.DefineSetting(
		"SmokeWind",
		20,
		"Wind smoke multiplier has been set to a factor of %.2f.",
		ACF.FloatDataCallback(0, 1000, 2)
	)
	...
	ACF.DefineSetting(
		"DetachedPhysmassRatio",
		false,
		"Detached entities affecting mass ratio has been %s.",
		ACF.BooleanDataCallback()
	)
	ACF.DefineSetting(
		"AllowProcArmor",
		false,
		"Procedural armor has been %s.",
		ACF.BooleanDataCallback(function(Value)
	...
	ACF.DefineSetting(
		"WorkshopExtras",
		false,
		"Extra Workshop content downloading has been %s.",
		ACF.BooleanDataCallback()
	)
	...
	ACF.DefineSetting(
		"NoclipOutsideZones",
		true,
		"Noclipping outside safezones has been %s.",
		ACF.BooleanDataCallback()
	)
	...
	ACF.DefineSetting(
		"TorqueMult",
		5,
		"The arbitrary multiplier for the final amount of torque. Stopgap measure until a future engine update.",
		ACF.FloatDataCallback(0, 10, 2)
	)
...
do -- ACF Convars & Particles
	CreateConVar(
		...
		"Maximum amount of ACF ammo crates a player can create."
	)
...
elseif CLIENT then
	CreateClientConVar(
		"acf_show_entity_info",
		1,
		true,
		false,
		"Defines under what conditions the info bubble on ACF entities will be shown. 0 = Never, 1 = When not seated, 2 = Always",
		0,
		2
	)
	...
	CreateClientConVar(
		...
		true,
		true,
		"Toggles the visibility of the links connecting mobility components."
	)
	CreateClientConVar(
		"acf_advancedmobilityropelinks",
		0,
		true,
		true,
		"Uses generated models to represent mobility links."
	)
	CreateClientConVar(
		"acf_maxroundsdisplay",
		16,
		true,
		false,
		"Maximum rounds to display before using bulk display (0 to only display bulk)",
		0,
		5000
	)
	...
	CreateClientConVar(
		...
		true,
		true,
		"If enabled, ACF will throw a warning hint whenever an entity gets disabled.",
		0,
		1
	)
	CreateClientConVar(
		...
		true,
		true,
		"If enabled, you will get a message in console from the server if someone else has an ACF entity get disabled, but only when the server has that logging enabled.",
		0,
		1
	)
	...
	CreateClientConVar(
		"acf_debris_giblifetime",
		60,
		true,
		false,
		"Defines lifetime in seconds of each debris gib.",
		1,
		300
	)
	CreateClientConVar(
		...
		true,
		false,
		"Defines lifetime in seconds of each debris entity.",
		1,
		300
	)
	...
	function ACF.HideInfoBubble()
		if ShowInfo_Value == 0 then
			return true
		end
		if ShowInfo_Value == 2 then
			return false
		end
	...
	ACF.CustomToolCategory = CreateClientConVar(
		"acf_tool_category",
		0,
		true,
		false,
		"If enabled, ACF tools will be put inside their own category.",
		0,
		1
	)
